import { Template, TemplateSection, TemplateItem } from './templates/types';

export class TemplateGenerator {
  
  generateTemplate(template: Template): void {
  ...
  private generateSection(section: TemplateSection, parent: FrameNode): void {
  ...
  private generateItem(item: TemplateItem, parent: FrameNode): void {
    switch (item.type) {
      case 'sticky':
  ...
  private generateStickyNote(item: TemplateItem, parent: FrameNode): void {
